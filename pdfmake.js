var fonts = {
    Roboto: {
        normal: 'public/libs/fonts/msyh.ttf',
        bold: 'public/libs/fonts/msyh.ttf',
        italics: 'public/libs/fonts/msyh.ttf',
        bolditalics: 'public/libs/fonts/msyh.ttf'
    }
};

var PdfPrinter = require('./public/libs/javascripts/pdfmake/printer');
var printer = new PdfPrinter(fonts);
var fs = require('fs');

var docDefinition = {
    content: [
        { text: '合同', style: 'header' },
