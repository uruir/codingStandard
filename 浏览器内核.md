...
Window10 发布后，IE 将其内置浏览器命名为 [Edge](https://www.zhihu.com/question/29985708)，Edge 最显著的特点就是新内核 EdgeHTML。

### Gecko (['gekəʊ])

Netscape6 开始采用的内核，后来的 Mozilla FireFox(火狐浏览器) 也采用了该内核，Gecko 的特点是代码完全公开。
...
在浏览器地址栏输入`chrome://version/`可查看到 Blink 的版本。
...
文章节选自：[主流浏览器内核介绍](http://web.jobbole.com/84826/)
